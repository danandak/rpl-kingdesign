...
@section('content')
<div style="margin-bottom: 6rem; background-color: #D9D9D9">
  ...
  <nav class="">
    <div class="nav nav-tabs pesanan-tabs d-flex justify-content-around bg-warning pb-2" id="nav-tab" role="tablist">
      ...
      <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Sedang Diproses</button>
      <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Revisi Design</button>
      <button class="nav-link" id="nav-disabled-tab" data-bs-toggle="tab" data-bs-target="#nav-disabled" type="button" role="tab" aria-controls="nav-disabled" aria-selected="false">Pesanan Selesai</button>
    </div>
  </nav>
            ...
            <div class="row">
              <div class="col-auto">
                <svg width="186" height="172" viewBox="0 0 186 172" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M55.005 105.415C39.4049 94.9585 29.2993 78.2249 29.2993 59.3659C29.2993 27.6836 57.8187 2 92.9993 2C128.18 2 156.699 27.6836 156.699 59.3659C156.699 77.9491 146.887 94.4688 131.674 104.952" stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M93 59.366L184 170H2L93 59.366Z" fill="#2F88FF" stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
