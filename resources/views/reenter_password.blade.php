...
<body>
    <div style="background-color: white; margin: 40px; width: auto;">
        ...
        <div class="name" style="margin-left: 495px; margin-right: 495px;">
            <label for="exampleFormControlInput1" class="form-label text-black fw-bold">New Password</label>

            <div class=" mt-2 mb-2">
                <input class="form-control" type="text" placeholder="New Password" aria-label="default input example">
            </div>
            <div class=" mt-2  mb-2">
                <input class="form-control" type="text" placeholder="Reenter Password" aria-label="default input example">
            </div>
        </div>
